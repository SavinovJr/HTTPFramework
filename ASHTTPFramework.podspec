...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Anton Savinov"
  # spec.authors            = { "Anton Savinov" => "anton-savinov@mail.ru" }
  # spec.social_media_url   = "https://twitter.com/Anton Savinov"
  ...
  spec.source       = { :git => "https://github.com/SavinovJr/HTTPFramework", :tag => "#{spec.version}" }
